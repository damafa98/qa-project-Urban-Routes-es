...
class UrbanRoutesPage:
    ...
    call_taxi_button = (By.CSS_SELECTOR,
                        '#root > div > div.workflow > div.workflow-subcontainer > div.type-picker.shown > div.results-container > div.results-text > button')

    # Prueba 2 : tarifa comfort
    # localizador para tarifa comfort
    comfort_tariff = (By.CSS_SELECTOR,
    ...
    comfort_extras = (
        By.CSS_SELECTOR,
        '#root > div > div.workflow > div.workflow-subcontainer > div.tariff-picker.shown > div.form > div.reqs.open > div.reqs-body > div.r.r-type-group > div > div.r-group-items > div:nth-child(2) > div > div.r-counter-label')
    ...
    button_send_phone_number = (By.CSS_SELECTOR,
    ...
    button_confirm_code = (By.CSS_SELECTOR,
    ...
    payment_method = (By.CSS_SELECTOR,
    ...
    add_payment_method = (By.CSS_SELECTOR,
                          '#root > div > div.payment-picker.open > div.modal > div.section.active > div.pp-selector > div.pp-row.disabled > div.pp-title')
    # input card number
    ...
    blanket_toggle_button = (
        By.CSS_SELECTOR,
        '#root > div > div.workflow > div.workflow-subcontainer > div.tariff-picker.shown > div.form > div.reqs.open > div.reqs-body > div:nth-child(1) > div > div.r-sw > div')
    ...
    search_taxi_pop_up = (
    By.CSS_SELECTOR, '#root > div > div.order.shown > div.order-body > div.order-header > div > div.order-header-title')
